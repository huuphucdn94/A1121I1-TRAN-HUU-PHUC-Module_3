...
public class Customer {
    ...
    public Customer(int customer_id, String customer_name, String customer_birthday, String customer_gender, int customer_id_card, int customer_phone, String customer_email, int customer_type_id, String customer_address) {
